...
void captureFirst (int argc, char *argv[], char * firstMulticastIP, int * port, int *vol, int * packetLength, int * verbose, int * bufferingTime);
...
void  captureArguments (int argc, char *argv[], int *operation, char * firstIP, char * firstMulticastIP, int *port, int *vol, int *packetDuration, int *verbose, int *payload, int *bufferingTime)
{
  ...
  if (strcmp ("first", argv[1]) == 0)
	...
	{
	  captureFirst (argc-1, argv, firstMulticastIP, port, vol, packetDuration, verbose, bufferingTime);
	}
    }
...
/*=====================================================================*/
void captureFirst (int argc, char *argv[], char * firstMulticastIP, int * port, int *vol, int * packetDuration, int * verbose, int * bufferingTime)
{
