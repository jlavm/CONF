/* 'diffTime.c'
To compile, put 'subtractTime.h' and 'subtractTime.c' in the same folder. Then...

gcc -Wall -c -o subtractTime.o subtractTime.c
gcc -Wall -c -o diffTime.o diffTime.c
gcc -Wall -o diffTime diffTime.o subtractTime.o

(or just   gcc -Wall -o diffTime diffTime.c subtractTime.c  ) 
